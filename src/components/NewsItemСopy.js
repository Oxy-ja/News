...
function NewsItems(props) {
  return (
    <div className="NewsItems">
      ...
      <div className="NewsItems-date">
        {formatDate(props.date)}
      </div>
      <div className="NewsItems-text">{props.title}</div>
...
const newsItem = {
  date: new Date(),
  title: 'Cостоялась отраслевая инвестиционная встреча по теме: «Развитие туризма. Строительство глэмпингов',
  photo: {
